  ...
  return (
    <div className="min-h-screen bg-[#0b0e10]" style={{ fontFamily: 'Inter, ui-sans-serif, system-ui, -apple-system, sans-serif', color: '#e0ddd8' }}>
      ...
      <nav className="sticky top-0 z-20 border-b border-[#1a1f25] bg-[#0c0f12]">
        <div className="mx-auto flex max-w-[1600px] items-center justify-between gap-4 px-5 py-3.5">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/admin/leads/new" prefetch className="inline-flex items-center gap-1.5 rounded-lg bg-[#d99a3d] px-3 py-2 text-xs font-bold text-[#1a0e00] transition-colors hover:bg-[#e6a845]">
      ...
      <main className="mx-auto max-w-[1600px] px-5 py-6">
        <div className="mb-5">
          <Link href="/admin" className="text-[11px] text-[#3a4048] hover:text-[#6b7580]">← Proposals</Link>
          <h1 className="mt-2 text-xl font-bold text-[#e0ddd8]">{lead.business_name}</h1>
          <p className="mt-1 text-[13px] text-[#4a5560]">{lead.address}</p>
        </div>
